...
export default function Home() {
  return (
    <main style={{ maxWidth: 980, margin: '0 auto', padding: 'var(--seed-dimension-x14) var(--seed-dimension-x7) 96px' }}>
      ...
      <h1 style={{ fontSize: 'var(--seed-font-size-t12)', fontWeight: 'var(--seed-font-weight-bold)', color: 'var(--seed-color-fg-neutral)', margin: 'var(--seed-dimension-x1_5) 0 var(--seed-dimension-x2_5)' }}>와이어프레임 &amp; 화면별 목업</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 'var(--seed-dimension-x4)', margin: 'var(--seed-dimension-x9) 0 var(--seed-dimension-x12)' }}>
        <CardLink href="/wireframes" title="와이어프레임" description="15개 화면 저충실도 설계 갤러리" />
