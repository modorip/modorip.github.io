...
export default function PrivacyPage() {
  return (
    <article style={legal.article}>
      ...
      <Section title="2. 위치정보를 수집하지 않습니다" emphasis>
        <p>
          서비스는 관광자원 근처에 도착했는지 확인하기 위해 <strong>단말기의 위치 권한</strong>을
          사용합니다. 그러나 <strong>위치 좌표는 단말기 안에서만 사용되며 운영자의 서버로
          전송되거나 저장되지 않습니다.</strong>
        </p>
        <p>
          거리 계산과 도착 판정은 전부 이용자의 단말기에서 이루어지고, 서버에는 그 결과인
          &ldquo;어떤 관광자원을 발견했는가&rdquo;만 전달됩니다. 운영자는 이용자가 언제 어디에
          있었는지 알 수 없습니다.
        </p>
        <p style={legal.note}>
          이 방침은 설계 단계에서 정해 문서로 고정한 것이며, 이용자의 이동 경로를 저장하지
          않기 위한 것입니다.
        </p>
      </Section>
