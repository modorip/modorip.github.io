      ...
      <Section title="5. 보유 및 이용 기간과 파기">
        ...
        <Table
          ...
          rows={[
            ...
            ['카드 사진', '지체 없이 파기'],
            ['카드 노트 (공개)', '남습니다 — 작성자는 익명으로 표시됩니다'],
            ['카드 노트 (나만 보기)', '지체 없이 파기'],
            ['발견 기록(관광자원·시각)', '남습니다 — 개인을 식별할 수 없는 통계로만'],
          ]}
        />
        <p style={legal.note}>
          공개 노트를 남기는 것은 다른 이용자가 보던 내용이 사라지지 않게 하기 위해서입니다.
          <strong>&ldquo;나만 보기&rdquo;로 둔 노트는 본 사람이 없으므로 함께 파기합니다.</strong>
